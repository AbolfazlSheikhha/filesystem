...
- [x] **1.8** mv — `deadbeef_rename` + standard `mv` command
...
sudo mv /mnt/deadbeef_test/moveme.txt /mnt/deadbeef_test/renamed.txt
ls /mnt/deadbeef_test/
# Should show renamed.txt, not moveme.txt

# Move to subdirectory
sudo mkdir /mnt/deadbeef_test/subdir
sudo mv /mnt/deadbeef_test/renamed.txt /mnt/deadbeef_test/subdir/
ls /mnt/deadbeef_test/subdir/
# Should show renamed.txt

# Move with overwrite
echo "file1" | sudo tee /mnt/deadbeef_test/file1.txt
echo "file2" | sudo tee /mnt/deadbeef_test/file2.txt
sudo mv /mnt/deadbeef_test/file1.txt /mnt/deadbeef_test/file2.txt
cat /mnt/deadbeef_test/file2.txt
# Should show: file1

# Rename directory
sudo mv /mnt/deadbeef_test/subdir /mnt/deadbeef_test/newdir
ls /mnt/deadbeef_test/
# Should show newdir, not subdir
```
